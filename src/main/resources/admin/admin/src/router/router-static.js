...
import center from '@/views/center'
    ...
    import qicheShijia from '@/views/modules/qicheShijia/list'
    ...
    import dictionaryQicheOrderPayment from '@/views/modules/dictionaryQicheOrderPayment/list'
    import dictionaryQicheShijiaOrderYesno from '@/views/modules/dictionaryQicheShijiaOrderYesno/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryQicheOrderPayment',
        name: '订单支付类型',
        component: dictionaryQicheOrderPayment
    }
    ,{
        path: '/dictionaryQicheShijiaOrderYesno',
        name: '预定审核',
        component: dictionaryQicheShijiaOrderYesno
    }
    ,{
        path: '/dictionarySex',
        name: '性别类型',
